...
<div class="container mt-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <p><strong>Tổng Giá Trị:</strong> <span class="text-danger">{{ format_currency($donnhaphang->TongGiaTri) }} VNĐ</span></p>
        </div>
    </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $chitiet->MaSP }}">
                            ...
                            <td class="total-price">{{ format_currency($chitiet->ThanhTien) }} VNĐ</td>
                            <td>
