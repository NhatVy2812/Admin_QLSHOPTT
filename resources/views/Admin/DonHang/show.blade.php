...
<div class="container mt-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <strong>Tổng Giá Trị:</strong> <span class="text-danger">{{ format_currency($donhang->TongGiaTri) }} VND</span>
                </div>
                <div class="col-md-6">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ format_currency($chitiet->DonGia) }} VND</td>
                            <td>{{ format_currency($chitiet->ThanhTien) }} VND</td>
